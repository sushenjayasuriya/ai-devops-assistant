...
public class StopContainerTool implements DevOpsTool {
    ...
    public String getDescription() {
        return "Stop a running Docker container. In PRODUCTION environments, this generates an approval request and requires human authorization.";
    }
    ...
    public ToolExecutionResult execute(Map<String, Object> parameters) {
        ...
        try {
            Map<String, Object> result = containerService.requestOrExecuteContainerAction(containerOpt.get().getId(), "stop");
